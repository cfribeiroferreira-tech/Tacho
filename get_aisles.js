...
console.log("Mozzarella/Queijo matches:");
Array.from(names).filter(n => n.toLowerCase().includes('moza') || n.toLowerCase().includes('mozz') || n.toLowerCase().includes('queijo')).forEach(n => console.log(n));
